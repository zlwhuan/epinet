...
public class DataSyncScheduler {
    ...
    static {
        ...
        API_URL_MAPPING.put(EdrDeathInfo.class, "/api/getDeathInfo");
        API_URL_MAPPING.put(EdrPrimaryDiagnosis.class, "/api/getPrimaryDiagnosisInfo");
        API_URL_MAPPING.put(EdrSymptomInfo.class, "/api/getSymptomInfo");
        API_URL_MAPPING.put(EdrExaminationInfo.class, "/api/getExaminationInfo");
        API_URL_MAPPING.put(EdrImagingExaminationInfo.class, "/api/getImagingExaminationInfo");
        API_URL_MAPPING.put(EdrConfirmedDiagnosisInfo.class, "/api/getConfirmedDiagnosisInfo");
        API_URL_MAPPING.put(EdrTreatmentInfo.class, "/api/getTreatmentInfo");
        API_URL_MAPPING.put(EdrMedicationInfo.class, "/api/getMedicationInfo");
        API_URL_MAPPING.put(EdrHospitalizationInfo.class, "/api/getHospitalizationInfo");
        API_URL_MAPPING.put(EdrLaboratoryTestingInfo.class, "/api/getLaboratoryTestingInfo");
        API_URL_MAPPING.put(EdrExposureHistoryInfo.class, "/api/getExposureHistoryInfo");
        API_URL_MAPPING.put(EdrTravelHistoryInfo.class, "/api/getTravelHistoryInfo");
